...
# Fish data
FISHIES = [
    {"name": "Blobette", "rarity": "R", "cost": 1},
    {"name": "Chef", "rarity": "R", "cost": 7},
    {"name": "Gerald", "rarity": "R", "cost": 1},
    {"name": "Goldfish", "rarity": "C", "cost": 1},
    {"name": "Largemouth", "rarity": "U", "cost": 2},
    {"name": "Mackerel", "rarity": "C", "cost": 3},
    {"name": "Magical Carp", "rarity": "L", "cost": 15},
    {"name": "Rainbow Trout", "rarity": "U", "cost": 9},
    {"name": "Shrimp", "rarity": "C", "cost": 6},
    {"name": "Yellow Perch", "rarity": "C", "cost": 7},
]
...
while running:
    ...
    money_text = font.render(f"Money: ${player.money}", True, w_color)
