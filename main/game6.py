...
# Set the start time at the beginning of the game
...
while running:
    ...
    remaining_time = max(0, time_limit - elapsed_time)  # Ensure it doesn't go negative
    ...
    time_text = font.render(f"Time: {remaining_time}s", True, b_color)
    time_rect = time_text.get_rect(bottomright=(790, 590))  # Position timer at bottom-right corner
